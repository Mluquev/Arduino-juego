...
_Transmitir contenido educativo ambiental, enfocado a la radiación UV, y la inclinación de un terreno por medio de una experiencia interactiva
Dinamizar el aprendizaje mediante dicha experiencia
incorporar elementos lúdicos y artísticos en el aprendizaje por medio de una experiencia interactiva
 _
...
_Usar el foto sensor para detectar la luz solar, y poder recolectar datos al respecto, usar el acelerómetro para medir la fuerza aplicada al arduino, y el micrófono para activar explicaciones al respecto_
